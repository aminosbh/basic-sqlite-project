...
*Open the project:*<br>
Run Code::Blocks, and open the project in `basic-sqlite-project/build/codeblocks`.<br>
Finally, build and run the project.
...
cd basic-sqlite-project
mkdir ../eclipse-basic-sqlite-project
cd ../eclipse-basic-sqlite-project

# Generate an Eclipse project
cmake ../basic-sqlite-project -G "Eclipse CDT4 - Unix Makefiles"
```
*Open the project:*<br>
Run Eclipse, and open the project in `eclipse-basic-sqlite-project`.<br>
